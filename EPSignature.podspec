...
8. Draws smoothly
DESC
  s.homepage         = "https://github.com/VishnuMU/EPSignature"
  s.license          = 'MIT'
  s.author           = { "Vishnu" => "vishnumu.inboxe@gmail.com" }
  s.source           = { :git => "https://github.com/VishnuMU/EPSignature.git", :tag => s.version.to_s }
